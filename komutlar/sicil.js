...
exports.run = async(client, message, args) => {    
 if(!message.member.roles.cache.some(r => ["824339767050240031", "824339690421354606"].includes(r.id))) //
...
if(!adam) {
 ...
 .setThumbnail(message.author.avatarURL())     
    ...
    .setDescription(`
<a:hydrastarrr:802176913757831198> •** Jaile Girme Sayısı: \`${jailsorgu}\`**
<a:hydrastarrr:802176913757831198> •** Mutelenme Sayısı: \`${mutesorgu}\`**
<a:hydrastarrr:802176913757831198> •** Uyarılma Sayısı: \`${uyarı}\`**
<a:hydrastarrr:802176913757831198> •** Toplam Ceza Puanın: \`${cezapuan}\`**
...
if(adam) {
 ...
 .setThumbnail(adam.avatarURL())     
    ...
    .setDescription(`
<a:hydrastarrr:802176913757831198> **• Jaile Girme Sayısı:  \`${jailsorgu2}\`**
<a:hydrastarrr:802176913757831198> **• Mutelenme Sayısı:  \`${mutesorgu2}\`**
<a:hydrastarrr:802176913757831198> **• Uyarılma Sayısı: \`${uyarı2}\`**
<a:hydrastarrr:802176913757831198> **• Toplam Ceza Puanları: \`${cezapuan2}\`**
